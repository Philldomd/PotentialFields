...
bool GraphicEngine::Initialize(int screenWidth, int screenHeight, bool vsync, HWND hwnd, bool fullscreen, 
...
void GraphicEngine::BeginScene(float red, float green, float blue, float alpha)
{
	float color[4];
...
ID3D11DeviceContext* GraphicEngine::GetDeviceContext()
{
	return m_deviceContext;
}

void GraphicEngine::GetProjectionMatrix(XMFLOAT4X4& projectionMatrix)
{
...
void GraphicEngine::GetWorldMatrix(XMFLOAT4X4& worldMatrix)
{
...
void GraphicEngine::GetOrthoMatrix(XMFLOAT4X4& orthoMatrix)
{
...
void GraphicEngine::GetVideoCardInfo(char* cardName, int& memory)
{
